...
class _LinkedInConnectDialogState extends State<LinkedInConnectDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text('Connect LinkedIn', style: TextStyle(fontSize: 20, color: Colors.greenAccent)),
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildTextField(_profileUrlController, 'Profile URL:'),
...
class _LeetCodeConnectDialogState extends State<LeetCodeConnectDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text('Connect LeetCode', style: TextStyle(fontSize: 20, color: Colors.greenAccent)),
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildTextField(_usernameController, 'LeetCode Username:'),
            if (_error != null)
              Padding(
                padding: const EdgeInsets.only(top: 8),
                child: Text(_error!, style: const TextStyle(color: Colors.redAccent)),
...
class _GFGConnectDialogState extends State<GFGConnectDialog> {
  ...
  Widget build(BuildContext context) {
    return AlertDialog(
      ...
      title: const Text('Connect GFG', style: TextStyle(fontSize: 20, color: Colors.greenAccent)),
      content: Form(
        key: _formKey,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            _buildTextField(_usernameController, 'GFG Username:'),
            _buildTextField(_emailController, 'Email:'),
            if (_error != null)
              Padding(
                padding: const EdgeInsets.only(top: 8),
